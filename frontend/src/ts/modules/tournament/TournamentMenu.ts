...
export class TournamentMenu
{
	...
	private renderList(tournaments: any[])
	{
		...
		console.log(`[TournamentMenu] Rendering ${tournaments.length} tournaments:`, tournaments);
	...
	public async joinTournament(id: string)
	{
		...
		try
		{
			this.router.navigateTo('tournament-lobby', id);
		}
		catch (e)
		{
			console.error(e);
	...
	public createTournamentClickHandler = async () =>
	{
		...
		try
		{
			this.router.navigateTo('tournament-lobby', '');
		}
		catch (e)
		{
			console.error(e);
